...
const ExcludeChunksPlugin = require('./exclude-chunks-plugin');
const ModuleNotFoundPlugin = require('./module-not-found-plugin');
const { generateTemplate } = require('./helpers');

module.exports = function getWebpackPlugins(urc) {
